...
assert.equal(basic.segments.length, 1);
assert.deepEqual(basic.segments[0], { x1: 0, y1: 0, x2: 100, y2: 100, pen: 0 });

const relative = parseHPGL('PU10,20;PD;PR5,6;PR-2,3;PU;');
assert.deepEqual(relative.segments[0], { x1: 10, y1: 20, x2: 13, y2: 29, pen: 0 });
